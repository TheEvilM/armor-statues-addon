...
execute if entity @p[tag=as_selected,scores={as_trigger=511114}] run tp @s ^-0.00625 ^ ^
execute if entity @p[tag=as_selected,scores={as_trigger=511115}] run tp @s ^0.00625 ^ ^
...
execute if entity @p[tag=as_selected,scores={as_trigger=511120}] run tp @s ^ ^-0.00625 ^
execute if entity @p[tag=as_selected,scores={as_trigger=511121}] run tp @s ^ ^0.00625 ^
...
execute if entity @p[tag=as_selected,scores={as_trigger=511126}] run tp @s ^ ^ ^-0.00625
execute if entity @p[tag=as_selected,scores={as_trigger=511127}] run tp @s ^ ^ ^0.00625
