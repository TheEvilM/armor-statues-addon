...
execute if entity @p[tag=as_selected,scores={as_trigger=511102}] run tp @s ^-0.00625 ^ ^
execute if entity @p[tag=as_selected,scores={as_trigger=511103}] run tp @s ^0.00625 ^ ^
...
execute if entity @p[tag=as_selected,scores={as_trigger=511108}] run tp @s ^ ^ ^-0.00625
execute if entity @p[tag=as_selected,scores={as_trigger=511109}] run tp @s ^ ^ ^0.00625
